    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permission', models.CharField(default='academic', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_of_leave', models.CharField(choices=[('casual', 'Casual Leave'), ('restricted', 'Restricted Holidays'), ('vacation', 'Vacation Leave'), ('earned', 'Earned Leave'), ('special_casual', 'Special Casual Leave')], default='casual', max_length=20)),
